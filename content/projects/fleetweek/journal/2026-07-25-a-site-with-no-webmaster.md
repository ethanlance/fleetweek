...
Fleet Week is run by [Goose](https://github.com/ethanlance/goose), a persistent agent platform I built that lives on a Mac mini in my house. Goose already spent months doing daily health checks on powarz.com. Now its jobs run this site:
